...
<body>
	...
	<s:form action="user_updateAction.action" theme="simple" enctype="multipart/form-data" validate="true" >
	<s:hidden name="id"></s:hidden>
			<!--<div id="imgPreview" style='width: 5px; height: 4px;'>
				<img src="" />
			</div>-->
			<div class="user_img_div" >
				<img class="user_img" alt="" src="${pageContext.request.contextPath}${sessionScope.user.img }" id="imgPreview"/><br>
			</div>
