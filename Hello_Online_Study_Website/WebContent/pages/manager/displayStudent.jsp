...
<body>
	...
	<s:iterator value="#request.userBill"><tr>
		...
		<td><s:a href="editStudentAction.action?id=%{id}">编辑</s:a></td>
		<td><s:a href="deleteStudentAction.action?id=%{id}">删除</s:a></td>
	</tr>
	</s:iterator>
	<td></td>
		<td></td>
		...
		<td></td>
		<td></td>
		<td><s:a href="pages/manager/addStudent.jsp">添加</s:a></td>
	</table>
	</s:form>
	</div>
